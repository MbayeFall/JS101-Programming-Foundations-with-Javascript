//In a switch statement, we need a break statement at the end of each case unless we explicitly use keyword return. Or else the following lines of code after each case keep on running
